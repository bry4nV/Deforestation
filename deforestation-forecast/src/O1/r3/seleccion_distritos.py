...
def seleccionar_distritos(
    ...
    columnas_base = [
        ...
        "porcentaje_amazonia",
        "pixeles",
        "pixeles_bosque_inicial",
        "porcentaje_bosque_inicial",
        "geometry"
    ]
    ...
    gdf_seleccionados.to_file(ruta_distritos_seleccionados, driver="GPKG", encoding="utf-8")

    print(f"[OK] Distritos seleccionados guardados: {ruta_distritos_seleccionados}")

    ruta_csv = ruta_distritos_seleccionados.replace(".gpkg", ".csv")
