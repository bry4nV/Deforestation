...
from O3.config import DISTRITOS_ALTO_CAMBIO_GPKG
from O3.utils import log_config, validar_fuentes
...
def main():
    ...
    # =====================================================================
    # PASO 0: CARGA DE GEOMETRÍAS BASE
    # =====================================================================
    ...
    print("\n" + "=" * 70)
    print(" O3 — Pipeline completo (Pasos 1–4)")
    print("=" * 70)
